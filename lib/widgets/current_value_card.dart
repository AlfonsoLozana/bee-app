    ...
    return Container(
      ...
      child: Stack(children: [
        ...
        Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          const SizedBox(height: 16),
          Row(children: [
            _StatItem(label: 'Mínimo',  value: p.minToday.toStringAsFixed(0)),
            _StatItem(label: 'Máximo',  value: p.maxToday.toStringAsFixed(0), color: AppColors.warning),
            _StatItem(label: 'Promedio', value: p.averageToday.toStringAsFixed(0)),
            _StatItem(label: 'Dosis',   value: p.dosesToday.toString(), color: AppColors.success),
          ]),
        ]),
      ]),
    );
